...
--          และข้อมูลที่ระบบค้นเจอจากฐานความรู้ (ใช้วัด retrieval hit rate)
-- ============================================================================
...
-- ---------------------------------------------------------------------------
-- 2) ตารางฐานความรู้กฎหมายภาษี (เผื่อกรณีติดตั้งก่อนหน้าที่ยังไม่มีตารางนี้)
-- ---------------------------------------------------------------------------
...
-- 4.2 อัตราการสืบค้นฐานความรู้สำเร็จ (retrieval hit rate)
